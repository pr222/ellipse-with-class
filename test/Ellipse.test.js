...
describe('Ellipse', () => {
  ...
  describe('Properties', () => {
    describe('area property', () => {
      it('Should be defined.', () => {
        expect(Ellipse.prototype)
          .to.have.property('area')
      })

      it('{ a = 78.2, b = 7.4 } should return a value near 1817.9768.', () => {
    ...
    describe('circumference property', () => {
      it('Should be defined.', () => {
        expect(Ellipse.prototype)
          .to.have.property('circumference')
      })

      it('{ a = 6, b = 9.7 } should return a value near 50.6742.', () => {
